...
void updateDisplay() {
  ...
  switch (deviceType) {
  case 0:
    u8g2.drawStr(0, 25, "[ Random ]");
    break;
  case 1:
    u8g2.drawStr(0, 25, "[ Airpods ]");
    break;
  case 2:
    u8g2.drawStr(0, 25, "[ Airpods Pro ]");
    break;
  case 3:
    u8g2.drawStr(0, 25, "[ Airpods Max ]");
    break;
  case 4:
    u8g2.drawStr(0, 25, "[ Airpods Gen 2 ]");
    break;
  case 5:
    u8g2.drawStr(0, 25, "[ Airpods Gen 3 ]");
    break;
  case 6:
    u8g2.drawStr(0, 25, "[ Airpods Pro 2 ]");
    break;
  case 7:
    u8g2.drawStr(0, 25, "[ Power Beats ]");
    break;
  case 8:
    u8g2.drawStr(0, 25, "[ Power Beats Pro ]");
    break;
  case 9:
    u8g2.drawStr(0, 25, "[ Beats Solo Pro ]");
    break;
  case 10:
    u8g2.drawStr(0, 25, "[ Beats Studio Buds ]");
    break;
  case 11:
    u8g2.drawStr(0, 25, "[ Beats Flex ]");
    break;
  case 12:
    u8g2.drawStr(0, 25, "[ Beats X ]");
    break;
  case 13:
    u8g2.drawStr(0, 25, "[ Beats Solo 3 ]");
    break;
  case 14:
    u8g2.drawStr(0, 25, "[ Beats Studio 3 ]");
    break;
  case 15:
    u8g2.drawStr(0, 25, "[ Beats Studio Pro ]");
    break;
  case 16:
    u8g2.drawStr(0, 25, "[ Beats Fit Pro ]");
    break;
  case 17:
    u8g2.drawStr(0, 25, "[ Studio Buds+ ]");
    break;
  default:
    u8g2.drawStr(0, 25, "[ Random ]");
    break;
...
void spooferLoop() {
  ...
  if (isAdvertising) {
    if (deviceType == 0) {
      deviceIndex = random(DEVICE_COUNT);
    } else {
