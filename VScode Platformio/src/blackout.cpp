...
// Button pins
#define BACK_BTN   BUTTON_PIN_LEFT
#define NEXT_BTN   BUTTON_PIN_RIGHT
#define TOGGLE_BTN BUTTON_PIN_UP
...
void blackoutSetup() {
  ...
  prevLeft  = digitalRead(BACK_BTN);
  prevRight = digitalRead(NEXT_BTN);
  prevUp    = digitalRead(TOGGLE_BTN);
}
